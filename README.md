...
```
**Sem dúvida em ruby com Watir é muito mais simples fazer, sem contar que a função está esperando o combobox ter valores, ou seja espera espera o options.length > 0 ser igual a true, por 30 segundos. Em Java precisaria colocar um Thread.sleep(30) para ter a mesma espera, mas não seria igual pois no caso do Watir a espera é dinâmica.
